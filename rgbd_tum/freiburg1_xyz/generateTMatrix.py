...
if __name__ == "__main__":
    ...
    for i in range(len(image_list)):
        ...
        file_location = "/your_location_path/rgbd_dataset_freiburg1_xyz/"
    ...
    pinhole_camera_intrinsic = read_pinhole_camera_intrinsic(
        "/your_location_pathrgbd_dataset_freiburg1_xyz/camera_primesense.json")

    # calculate transformation matrix for each pair
    print len(imgColor_list)-2
    for i in range(770, len(imgColor_list)-1):
    #for i in range(791,792):
